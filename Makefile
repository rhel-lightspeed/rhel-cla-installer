...
# redhat.io/rhel-cla-operator-bundle:$VERSION and redhat.io/rhel-cla-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= redhat.io/rhel-cla-operator
...
ifeq (,$(shell which ansible-operator 2>/dev/null))
	...
	curl -sSLo $(ANSIBLE_OPERATOR) https://github.com/operator-framework/ansible-operator-plugins/releases/download/v1.42.3/ansible-operator_$(OS)_$(ARCH) ;\
